...
public class FirebaseStorageService {
    ...
    // Aqui se manejaria la inyeccion del cliente de Storage como un bean
    ...
    private String uploadToFirebase(File file, String folder, String fileName) throws IOException {
        // Definimos el ID del blob y su informacion
        ...
        // Se genera la URL firmada. Ahora con una caducidad de 5 anios.
        return storage.signUrl(blobInfo, 1825, TimeUnit.DAYS).toString();
    }

    /**
     * Genera un string numerico con un formato de 14 digitos, rellenado con
